...
const Estimates = () => {
  ...
  const downloadEstimatePDF = async (estimate) => {
    try {
      ...
      const customerName = getCustomerDisplay(estimate.customer).name;
  ...
  const getFilteredEstimates = () => {
    ...
    return baseEstimates.filter(estimate => {
      const customerData = getCustomerDisplay(estimate.customer);
      const matchesSearch = estimate.estimateNumber?.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           ...
                           customerData.phone.includes(searchTerm) ||
                          ...
                          {user.role !== 'customer' && (
                            <td>
                              <div className="customer-cell">
                                <div className="customer-name">{getCustomerDisplay(estimate.customer).name}</div>
                                <div className="customer-phone">{getCustomerDisplay(estimate.customer).phone}</div>
                              </div>
                            </td>
                          )}
              ...
              <div className="estimate-view">
                <div className="estimate-header">
                  <div className="estimate-info">
                    <p><strong>Customer:</strong> {getCustomerDisplay(viewingEstimate.customer).displayText}</p>
